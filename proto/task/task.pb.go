...
type CreateTaskRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Title         string                 `protobuf:"bytes,1,opt,name=title,proto3" json:"title,omitempty"`             // Заголовок задачи для создания
...
type UpdateTaskRequest struct {
	...
	Description   string                 `protobuf:"bytes,3,opt,name=description,proto3" json:"description,omitempty"` // New description of the task
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_proto_task_task_proto_rawDesc = "" +
	"\n" +
	"\x15proto/task/task.proto\x12\x04task\"N\n" +
	"\x04Task\x12\x0e\n" +
	...
	"\tListTasks\x12\x16.task.ListTasksRequest\x1a\x17.task.ListTasksResponseB0Z.github.com/soso4ek99/project-protos/proto/taskb\x06proto3"
